...
```sh
curl -XGET 'https://api.aglaia.io/oauth/authorize?response_type=token&client_id=13d693d0-d66c-11e9-89b7-df5b4df0afb3&redirect_uri=https://webhook.site/5bb5b879-8e43-4322-9fc0-50c30325516b&scope=wm-api:admin&state=xcoiv98y2kd22vusuye3kch&state=teste_123'
```
...
```sh
curl -XGET 'https://api.aglaia.io/oauth/authorize?response_type=code&client_id=13d693d0-d66c-11e9-89b7-df5b4df0afb3&redirect_uri=https://webhook.site/5bb5b879-8e43-4322-9fc0-50c30325516b&scope=wm-api:admin&state=xcoiv98y2kd22vusuye3kch&state=teste_123'
```
